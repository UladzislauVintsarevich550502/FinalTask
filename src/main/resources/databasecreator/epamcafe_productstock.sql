...
CREATE TABLE `productstock` (
  `productSale` decimal(3,2) DEFAULT '0.00',
  `productId` int(11) unsigned NOT NULL,
  PRIMARY KEY (`productId`),
  CONSTRAINT `fk_productstock_product1` FOREIGN KEY (`productId`) REFERENCES `product` (`productId`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `productstock` VALUES (1.00,9);
