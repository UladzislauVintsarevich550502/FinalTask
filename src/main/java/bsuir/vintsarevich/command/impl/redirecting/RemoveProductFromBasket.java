...
public class RemoveProductFromBasket implements ICommand {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            Integer productId = Integer.valueOf(request.getParameter(AttributeName.PRODUCT_ID.getValue()));
            Double orderCost = productService.getProductById(productId).getCost();
            Integer productCount = Integer.valueOf(request.getParameter(AttributeName.NUMBER_FOR_DELETE.getValue()));
