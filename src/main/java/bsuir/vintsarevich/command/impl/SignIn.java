...
//    private static final JspPageName jspPageName = JspPageName.TEST;
//    private Role role;
//
//    @Override
//    public String execute(HttpServletRequest request, HttpServletResponse response) {
//        LOGGER.log(Level.INFO,"Sign In");
//        String login = request.getParameter(JspElemetName.LOGLOGIN.getValue());
//        String password = request.getParameter(JspElemetName.LOGPASSWORD.getValue());
//
