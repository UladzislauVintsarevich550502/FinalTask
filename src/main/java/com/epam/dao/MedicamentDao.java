...
public class MedicamentDao implements IMedicamentDao {
    public static String GET_ALL_MEDICAMENTS = "SELECT * FROM pharmacy.medicament;";
    public static String GET_SORTED_BY_PRICE_MEDICAMENTS_ASC = "SELECT * FROM pharmacy.medicament ORDER BY price ASC;";
    public static String GET_SORTED_BY_PRICE_MEDICAMENTS_DESC = "SELECT * FROM pharmacy.medicament ORDER BY price DESC;";
    public static String GET_MEDICAMENT_BY_ID = "SELECT * FROM pharmacy.medicament WHERE idMedicament=?;";
    public static String ADD_MEDICAMENT = "INSERT INTO medicament (name,producer,price,prescription,image,availability) VALUES(?,?,?,?,?,?);";
    public static String GET_MEDICAMENTS_BY_PRODUCER = "SELECT * FROM pharmacy.medicament WHERE producer=?;";
    public static String GET_MEDICAMENT_BY_NAME = "SELECT * FROM pharmacy.medicament WHERE name LIKE ?;";
    public static String EDIT_MEDICAMENT = "UPDATE pharmacy.medicament SET (name, producer, price, prescroption, image, availability) VALUES(?,?,?,?,?,?) WHERE idMedicament=?;";
    public static String GET_MEDICAMENTS_BY_PRESCRIPTION = "SELECT * FROM pharmacy.medicament WHERE prescription=?;";
