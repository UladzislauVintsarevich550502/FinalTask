...
public class EditMedicament implements com.epam.command.ICommand {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) {
        ...
        logger.debug("\"" + ((String) request.getSession().getAttribute(RequestEnum.LOGIN.getValue())) + "\" try to edit medicament");
        try {
            ...
            logger.error(((String) request.getSession().getAttribute(RequestEnum.LOGIN.getValue())), e);
